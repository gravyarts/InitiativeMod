...
public class LBIndicatorsShort extends Block implements IHaveItem {
	private static final AxisAlignedBB BUTTON_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 1.0D, 1.0D);
	public LBIndicatorsShort(Material material) {
		super(material);
